...
<div id="container">
    ...
    <div class="content">
        ...
        <p class="hello">Добро пожаловать в наш интернет-магазин ноутбуков, у нас огромный ассортимент комплектующих и
            расходных материалов для ремонта ноутбуков, планшетов и телефонов. </p>
        <hr>
        <?php
    ...
    <div class="load-more-wrapper" style="display: flex; justify-content: center;">
        <button class="load-more" style="width: 150px;height: 25px; ">Еще</button>
    </div>
    <footer>
